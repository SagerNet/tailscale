...
func cmdName(exe string) string {
	...
	// v is like:
	// "path\tgithub.com/sagernet/tailscale/cmd/tailscale\nmod\tgithub.com/sagernet/tailscale\t(devel)\t\ndep\tgithub.com/apenwarr/fixconsole\tv0.0.0-20191012055117-5a9f6489cc29\th1:muXWUcay7DDy1/hEQWrYlBy+g0EuwT70sBHg65SeUc4=\ndep\tgithub....
	for _, line := range strings.Split(info, "\n") {
		if goPkg, ok := strings.CutPrefix(line, "path\t"); ok { // like "github.com/sagernet/tailscale/cmd/tailscale"
